...
fun AndroidLibraryExplainedPreview() {
  Column {
    ...
    Spacer(modifier = Modifier.height(16.dp))
    Text(text = "We will get into more detail about what that means later, but for now don't worry if you don't understand all of the details of what a library is.")
    Spacer(modifier = Modifier.height(16.dp))
    ...
    Spacer(modifier = Modifier.height(16.dp))
    Text(text = "Think of a real life library again, to find a book you're looking for, you may look at signs on the walls to find where it’s located so you can retrieve it.")
    Spacer(modifier = Modifier.height(16.dp))
